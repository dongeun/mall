...
public class PolicyHandler{
    ...
    public void wheneverDeliveryCompleted_StockDecrease(@Payload DeliveryStarted deliveryStarted){
    ...
    public void wheneverDeliveryReturned_StockIncrease(@Payload DeliveryCanceled deliveryCanceled){
